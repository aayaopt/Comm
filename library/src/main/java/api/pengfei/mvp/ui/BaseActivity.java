...
//        LogUtil.d("onUnsubscribe");
    ...
    public Toolbar initToolBar(String title, int barID, int tvID) {

        Toolbar toolbar = (Toolbar) findViewById( barID);
        if (toolbar != null) {
            setSupportActionBar(toolbar);
            TextView toolbaTitle = (TextView) toolbar.findViewById(tvID);
    ...
    public Toolbar initToolBarAsHome(String title, int barID, int tvID) {
